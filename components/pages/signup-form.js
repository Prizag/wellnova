    ...
    <div className="space-y-4 py-2">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <RadioGroup defaultValue="patient" onValueChange={setRole} className="flex flex-col space-y-1">
          ...
          <p className="text-xs text-muted-foreground mt-1">Note: Doctor and Admin accounts require verification</p>
        </div>
